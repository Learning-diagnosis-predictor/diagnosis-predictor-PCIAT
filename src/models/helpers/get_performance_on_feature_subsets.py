...
def get_cv_scores_on_feature_subsets(feature_subsets, datasets, best_estimators):
    ...
    for output in datasets.keys():
        print("Getting CV scores on feature subsets for " + output)
...
def re_train_models_on_feature_subsets(feature_subsets, datasets, best_estimators):
    estimators_on_feature_subsets = {}
    for output in datasets.keys():
        print("Re-training models on feature subsets for output: " + output)
...
def get_performances_on_feature_subsets(feature_subsets, datasets, best_estimators, estimators_on_feature_subsets, use_test_set):
    ...
    for i, output in enumerate(feature_subsets):
        if output in datasets.keys():
            ...
            performances_on_subsets[output] = (output, feature_subsets, estimators_on_feature_subsets, datasets, use_test_set)
